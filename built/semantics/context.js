...
class Context {
    ...
    assertIsFunction(entity) {
        if (entity.constructor !== function_object_1.default) {
...
new function_declaration_1.default('print', [new parameter_1.default('_', null)], null).analyze(Context.INITIAL);
new function_declaration_1.default('sqrt', [new parameter_1.default('_', null)], null).analyze(Context.INITIAL);
